#!/usr/bin/python
#
# Convert a blast outfmt=6 file to GFF3 format, taking some static values on the command line.
# Sets Note=source so it shows up on GBrowse searches.

import sys
import argparse

parser = argparse.ArgumentParser(description="Convert a blast outfmt 6 file to GFF3 format, taking source, feature and assembly on the command line. Sets Note=source to enable GBrowse searches.")
